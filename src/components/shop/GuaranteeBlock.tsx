...
export default function GuaranteeBlock({ compact }: Props) {
  ...
  if (compact) {
    return (
      <div className="group relative w-full rounded-2xl bg-[#3A2115] px-4 py-3.5 transition-all duration-200 cursor-default hover:-translate-y-0.5 hover:shadow-[0_8px_24px_rgba(44,24,16,0.35)] hover:bg-[#3A2115]">
        <p className="text-[16px] font-bold text-white">{t('compact_title')}</p>
        <p className="text-[14px] text-[rgba(255,255,255,0.8)]">{t('compact')}</p>
