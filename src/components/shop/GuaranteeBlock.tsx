...
export default function GuaranteeBlock({ compact }: Props) {
  ...
  if (compact) {
    return (
      <div className="group relative w-full rounded-[12px] bg-[#4A2C1A] px-5 py-4 transition-all duration-200 cursor-default hover:-translate-y-0.5 hover:shadow-[0_8px_24px_rgba(44,24,16,0.35)] hover:bg-[#4A2C1A]">
