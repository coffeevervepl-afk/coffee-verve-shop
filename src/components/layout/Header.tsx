...
const NAV_CTA    = 'nav-cta-btn flex items-center gap-1 rounded-full border border-white/40 bg-white/60 px-4 py-1.5 text-[14px] font-semibold uppercase tracking-[0.04em] text-[#3A2115] backdrop-blur-sm transition-colors hover:bg-white/80'
