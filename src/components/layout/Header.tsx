...
const SOCIAL_LINKS = [
  ...
  { href: 'https://wa.me/48573994584',                  icon: WhatsAppIcon,  color: '#25D366', label: 'WhatsApp' },
  { href: 'https://t.me/coffeeverve_shop',              icon: TelegramIcon, color: '#229ED9', label: 'Telegram' },
]
